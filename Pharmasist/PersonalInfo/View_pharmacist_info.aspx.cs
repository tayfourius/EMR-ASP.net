...
public partial class Pharmacist_View_pharmacist_info : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
       // x.Id = 3;
        ...
        x = Q.Pharmacists.Where(k => k.PersonalInfoId == p.Id).SingleOrDefault();
    ...
    {
        Response.Redirect("~/EMR Template/Pharmasist/prescription/Select_Prescription.aspx");
    }
    protected void Button2_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/EMR Template/Pharmasist/prescription/ViewAll_Prescripton.aspx");
    }
}
