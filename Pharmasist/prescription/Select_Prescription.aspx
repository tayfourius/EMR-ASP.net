<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Select_Prescription.aspx.cs" Inherits="prescription_Select_Prescription" %>
...
<link href="style.css" rel="stylesheet" type="text/css" media="screen" />
    ...
    <title>Select Prespection</title>
</head>
<body>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Options</h2>
                        <ul>
                            <li>
                                <asp:Button ID="Button2" runat="server" BackColor="White" BorderStyle="None" 
                                    Height="19px" onclick="Button2_Click" Text="View All prespection" 
                                    Width="161px" />
                            </li>
                            <li></li>
                            <li></li>
        ...
        <asp:Label ID="Label1" runat="server" Text="Enter No. Prescription :"></asp:Label>
&nbsp;<br />
        <br />
        <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
&nbsp;<asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
            style="width: 31px" Text="Go" />
