...
public partial class Nurse_Nurse_View_info : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("~/EMR Template/Nurse/Nurse_preview/ViewALL_TestXray.aspx");
    }

    protected void Button1_Click(object sender, EventArgs e)
    {
        Response.Redirect("~/EMR Template/Nurse/Nurse_preview/Select_NursePreview.aspx.aspx");
    }
}
