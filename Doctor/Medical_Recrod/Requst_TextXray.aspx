...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:Label ID="Label15" runat="server" Text="Label" Font-Bold="True"></asp:Label>
                            ...
                            <asp:Label ID="Label6" runat="server" Text="Add New Disease "></asp:Label>
                            <asp:Label ID="Label7" runat="server" Text="for Patient :"></asp:Label>
                            <asp:Label ID="Label8" runat="server" Font-Bold="False" Text="Label"></asp:Label>
&nbsp;<asp:Label ID="Label9" runat="server" Text="Label"></asp:Label>
&nbsp;<asp:Label ID="Label10" runat="server" Text="By Doctor :"></asp:Label>
