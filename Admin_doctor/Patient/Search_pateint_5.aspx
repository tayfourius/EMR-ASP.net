<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Search_pateint_5.aspx.cs" Inherits="search_Search_pateint_5" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Doctor Main</h2>
    ...
    <asp:Button ID="Button88" runat="server" onclick="Button1_Click" 
        Text="Search Pateint" />
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        ...
        GridLines="None" Width="645px" onselectedindexchanging="GridView1_SelectedIndexChanging"
        PageSize="4" ShowFooter="True" AllowPaging="True">
