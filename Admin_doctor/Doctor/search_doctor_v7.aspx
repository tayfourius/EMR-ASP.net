<%@ Page Language="C#" AutoEventWireup="true" CodeFile="search_doctor_v7.aspx.cs" Inherits="search_search_doctor_v7" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Doctor Main</h2>
    ...
    <asp:TextBox ID="TextBox1" runat="server" style="margin-bottom: 0px"></asp:TextBox>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            ...
            onselectedindexchanging="GridView1_SelectedIndexChanging" Width="548px"  >
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:CommandField ButtonType="Image" HeaderText="Select" 
                    InsertImageUrl="~/images/enter.gif" ShowSelectButton="True" />
