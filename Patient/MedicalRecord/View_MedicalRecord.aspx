...
&nbsp;<asp:Label ID="Label9" runat="server" Text="Label"></asp:Label>
        <br />
        <br />
        <asp:Label ID="Label20" runat="server" Text=" Medical Record  Info :"></asp:Label>
        <br />
        <br />
        ...
        <br />
        <br />
        <asp:Label ID="Label19" runat="server" Text="Disease Info :"></asp:Label>
        <br />
        <br />
        <asp:Label ID="Label21" runat="server" Text="Disease Name :"></asp:Label>
        <asp:Label ID="Label26" runat="server" Text="Label"></asp:Label>
        <br />
        <asp:Label ID="Label22" runat="server" Text="Disease Type :"></asp:Label>
        <asp:Label ID="Label27" runat="server" Text="Label"></asp:Label>
        <br />
        <asp:Label ID="Label23" runat="server" Text="Level of Risk :"></asp:Label>
        <asp:Label ID="Label28" runat="server" Text="Label"></asp:Label>
        <br />
        <asp:Label ID="Label24" runat="server" Text="Disease Description :"></asp:Label>
        <asp:Label ID="Label29" runat="server" Text="Label"></asp:Label>
        <br />
        <asp:Label ID="Label25" runat="server" Text="Treatment Plan :"></asp:Label>
