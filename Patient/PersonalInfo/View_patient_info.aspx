<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_patient_info.aspx.cs" Inherits="View" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Options</h2>
                        <ul>
                            ...
                            <li>
                                <asp:Button ID="Button2" runat="server" BackColor="White" BorderStyle="None" 
                                    Height="19px" onclick="Button2_Click" Text="View All emr" Width="161px" />
                            </li>
                            <li>
                                <asp:Button ID="Button1" runat="server" onclick="Button1_Click" 
                                    Text="Add medical" BackColor="White" BorderStyle="None" Height="19px" 
                                    Width="161px" />
                            </li>
                            <li></li>
                            <li></li>
			...
			<div id="content">
				<div class="post">
					<h2 style="color: #808080">View patient Info </h2>
					<div class="entry">
						<p>
        ...
        &nbsp;<asp:Label ID="Label26" runat="server" Text="Label"></asp:Label>
						...
						<p>
                            <table style="width: 98%; height: 240px; margin-right: 0px;">
                                <tr>
                                    <td class="style2">
        <asp:Image ID="Image1" runat="server" Height="171px" Width="184px" BorderColor="Black" BorderWidth="2px" />
                                    </td>
                                    <td class="style6">
                                        <table style="width: 100%; height: 164px; margin-top: 0px;">
                                            <tr>
                                                <td class="style8">
                                                    Gender:</td>
                                                <td class="style5">
        ...
        <asp:Label ID="Label28" runat="server" Text="Label"></asp:Label>
                                    ...
                                    <td class="style3">
                                        <table style="width: 103%; height: 162px; margin-left: 0px;">
                                            <tr>
                                                <td class="style18">
                                                    Blood: </td>
                                                <td>
